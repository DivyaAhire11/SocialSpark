  ...
  return (
    <div className={`flex items-start justify-between py-4 ${disabled ? 'opacity-50' : ''}`}>
      ...
      <button
        ...
        className={`relative inline-flex h-6 w-11 shrink-0 cursor-pointer rounded-full border-2 border-transparent transition-colors duration-200 ease-in-out focus:outline-none focus:ring-2 focus:ring-[#581C87] focus:ring-offset-2 ${
          enabled ? 'bg-[#581C87]' : 'bg-gray-200'
        }`}
      >
        <span
