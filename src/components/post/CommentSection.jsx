    ...
    <div className="space-y-3">
      ...
      {user && (
        <form onSubmit={handleSubmit} className="flex gap-2 items-center">
          <Avatar src={profile?.avatar_url} alt={user?.email} size="xs" className="flex-shrink-0" />
          <div className="flex-1 relative">
            <input
              ...
              className="w-full bg-gray-50 border border-gray-200 rounded-full px-4 py-2 text-xs
            ...
            <button
              ...
              className="absolute right-2 top-1/2 -translate-y-1/2 text-[#8B5CF6] hover:text-[#7C3AED] disabled:opacity-30 transition-colors p-1"
            >
